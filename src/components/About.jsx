				...
				<div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
					...
					<div className="lg:order-first lg:row-span-2">
						...
						<div className="mt-6 space-y-7 text-lg  text-dmDark">
							...
							<p>
								DM Brokers stands as a leading insurance brokerage firm, specialising in both business and personal insurance solutions. With extensive experience in the insurance industry, our commitment lies in providing clients with expert advice, tailored coverage options, and exceptional service.
							</p>
							<p>
								Our team of knowledgeable insurance professionals is unwavering in their dedication to understanding clients' unique needs. Catering to a diverse clientele, from small enterprises to large corporations, as well as individuals and families, we ensure the safeguarding of their assets and effective risk management.
							</p>
							<p>
							...
							<p>Thank you for considering DM Brokers as your insurance partner; we look forward to the opportunity of serving your insurance needs and earning your trust.</p>
							{/* <p>
